...
Item {
    ...
    implicitWidth: vertical ? btnSize : (root.style === "space" ? root.dividerSpacing : root.style === "dot" ? dotText.implicitWidth + 10 : (1 + btnSpacing * 3))
    implicitHeight: vertical ? (root.style === "space" ? root.dividerSpacing : root.style === "dot" ? dotText.implicitHeight + 16 : (1 + btnSpacing * 3)) : btnSize
