    ...
    property var allWidgets: [
        {
            ...
            name: Translation.tr("Left Sidebar Button"),
        ...
        {
            id: "systemIcons",
            name: Translation.tr("System Icons"),
            icon: "info"
        },
        {
            id: "networkSpeed",
            name: Translation.tr("Network Speed"),
            icon: "network_check"
        },
        {
            id: "clockWidget",
        ...
        {
            id: "utilButtons",
            name: Translation.tr("Util Buttons"),
            icon: "toggle_on"
        },
        {
            id: "sysTray",
        ...
        {
            id: "activeWindow",
            name: Translation.tr("Active Window"),
            icon: "subtitles"
        },
        {
            id: "powerButton",
            name: Translation.tr("Power Button"),
        ...
        {
            id: "docktoPanel",
            name: Translation.tr("Dock to Panel"),
            icon: "apps"
        },
        {
            id: "hyprlandXkbIndicator",
            name: Translation.tr("Keyboard Layout"),
            icon: "keyboard"
        },
        {
            id: "divisor",
            name: Translation.tr("Divider"),
            icon: "horizontal_distribute"
        },
        {
            id: "launcherButton",
            name: Translation.tr("Launcher Button"),
            icon: "search"
        },
    ]

    function availableFor() {
        let used = [...Config.options.bar.layouts.leftLayout, ...Config.options.bar.layouts.middleLayout, ...Config.options.bar.layouts.rightLayout];
        const multipleAllowed = ["visualizer", "divisor"];
        return allWidgets.filter(w => {
            if (w.id === "divisor" && Config.options.bar.borderless !== "transparent")
                return false;
                        ...
                        delegate: Rectangle {
                            ...
                            ConfigSwitch {
                                ...
                                onCheckedChanged: {
                                    ...
                                    if (checked) {
                                        if (!list.includes(monitorRow.modelData.name))
                                            list.push(monitorRow.modelData.name);
                                    } else {
        ...
        ContentSection {
            ...
            GroupedList {
                ...
                ConfigSwitch {
                    ...
                    text: Translation.tr("Center on Workspaces")
                    checked: Config.options.bar.centerOnWorkspaces
                    onCheckedChanged: {
                        Config.options.bar.centerOnWorkspaces = checked;
                    }
                }
            ...
            GroupedList {
                ...
                ConfigSelectionArray {
                    ...
                    options: [
                        ...
                        {
                            displayName: Translation.tr("Separated"),
                            icon: "view_column_2",
                            value: "separated"
                        },
                        {
                            displayName: Translation.tr("Segmented"),
                            icon: "tablet",
                            value: "segmented"
                        },
                    ]
